...
namespace NDex
{
        ...
        where TSourceList2 : IList<TSource>
    {
        ...
        {
            int result = Sublist.AddExcept<TSourceList1, TSourceList2, TDestinationList, TSource>(
        ...
        {
            Tuple<int, int, int> indexes = Sublist.CopyExcept<TSourceList1, TSourceList2, TDestinationList, TSource>(
                source1.List, source1.Offset, source1.Offset + source1.Count,
                source2.List, source2.Offset, source2.Offset + source2.Count,
