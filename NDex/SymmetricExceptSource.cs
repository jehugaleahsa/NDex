...
namespace NDex
{
    ...
    public static partial class Sublist
    {
        ...
        /// the lists can contain duplicate items.
        /// </remarks>
        public static SymmetricExceptResult CopySymmetricDifference<TSourceList1, TSourceList2, TDestinationList, T>(
            IReadOnlySublist<TSourceList1, T> source1,
            IReadOnlySublist<TSourceList2, T> source2,
        ...
        private static SymmetricExceptResult copySymmetricDifference<TSourceList1, TSourceList2, TDestinationList, T>(
            IReadOnlySublist<TSourceList1, T> source1,
            IReadOnlySublist<TSourceList2, T> source2,
            IMutableSublist<TDestinationList, T> destination,
            Func<T, T, int> comparison)
    ...
    internal sealed class SymmetricExceptSource<TSourceList1, TSourceList2, TSource> : Source<TSource, SymmetricExceptResult>
