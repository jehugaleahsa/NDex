...
namespace NDex
{
    ...
    public static partial class Sublist
    {
        ...
        /// the lists can contain duplicate items.
        /// </remarks>
        public static IntersectResult CopyIntersection<TSourceList1, TSourceList2, TDestinationList, T>(
            IReadOnlySublist<TSourceList1, T> source1,
            IReadOnlySublist<TSourceList2, T> source2,
        ...
        private static IntersectResult copyIntersection<TSourceList1, TSourceList2, TDestinationList, T>(
            IReadOnlySublist<TSourceList1, T> source1,
            IReadOnlySublist<TSourceList2, T> source2,
            IMutableSublist<TDestinationList, T> destination,
            Func<T, T, int> comparison)
    ...
    internal sealed class IntersectSource<TSourceList1, TSourceList2, TSource> : Source<TSource, IntersectResult>
        ...
        where TSourceList2 : IList<TSource>
    {
        ...
        {
            return Sublist.AddIntersection(source1, source2, destination, comparison);
        }

        protected override IntersectResult SafeCopyTo<TDestinationList>(IMutableSublist<TDestinationList, TSource> destination)
        {
            return Sublist.CopyIntersection(source1, source2, destination, comparison);
        }
    }
