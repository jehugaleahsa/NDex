...
namespace NDex
{
        ...
        where TSourceList2 : IList<TSource>
    {
        ...
        {
            int result = addUnion<TDestinationList>(
        ...
        private static int addUnion<TDestinationList>(
        ...
        {
            Tuple<int, int, int> indexes = copyUnion<TDestinationList>(
                source1.List, source1.Offset, source1.Offset + source1.Count,
        ...
        private static Tuple<int, int, int> copyUnion<TDestinationList>(
            TSourceList1 source1, int first1, int past1,
            TSourceList2 source2, int first2, int past2,
