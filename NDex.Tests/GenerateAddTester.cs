...
{
    /// <summary>
    /// Tests the GenerateAdd methods.
    /// </summary>
    [TestClass]
    public class GenerateAddTester
    {
        #region Real World Examples

        /// <summary>
        /// GenerateAdd can be used to populate an array with incrementing values.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// GenerateAdd can be used to populate an array with default values.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// GenerateAdd can be used to populate an array with random values.
        /// </summary>
        [TestMethod]
        public void TestGenerateAdd_WithRandomValues()
        {
        ...
        /// </summary>
        [TestMethod]
        public void TestGenerateAdd_SetValueType()
        {
        ...
        /// </summary>
        [TestMethod]
        public void TestGenerateAdd_WithGenerator_CallCtor()
        {
            var list = TestHelper.Wrap(new List<int>());
            int numberOfItems = 5;
        ...
        /// </summary>
        [TestMethod]
        public void TestGenerateAdd_IncrementingCount()
        {
            var list = TestHelper.Wrap(new List<int>());
            int numberOfItems = 4;
