...
namespace NDex.Test
{
    ...
    public class TypedListTester
    {
        ...
        public void TestAdd_AddsToEnd()
        {
            ...
            Assert.IsTrue(Sublist.AreEqual(expected.ToSublist(), actual.ToSublist()), "The item wa not added as expected.");
        }
        ...
        public void TestInsert_IndexAtEnd_InsertsInFront()
        {
            ...
            int[] expected = { 1, 2, 3, 4 };
            int[] actual = toTypedArray(list.List);
            Assert.IsTrue(Sublist.AreEqual(expected.ToSublist(), actual.ToSublist()), "The item was not inserted as expected.");
        }
        ...
        public void TestRemove_FindsValue_ReturnsTrue()
        {
            ...
            int[] expected = { 1, 2, };
            int[] actual = toTypedArray(list.List);
            Assert.IsTrue(Sublist.AreEqual(expected.ToSublist(), actual.ToSublist()), "The item was not removed from the list.");
        }
        ...
        public void TestRemoveAt_IndexAtEnd_RemovesFromFront()
        {
            ...
            int[] expected = { 1, 2 };
            int[] actual = toTypedArray(list.List);
            Assert.IsTrue(Sublist.AreEqual(expected.ToSublist(), actual.ToSublist()), "The item was not removed as expected.");
        }
