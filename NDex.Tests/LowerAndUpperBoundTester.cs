    ...
    public class LowerAndUpperBoundTester
    {
        ...
        public void TestLowerAndBound_RemoveDuplicates()
        {
            ...
            for (int index = 0; index != list.Count; ++index)
            {
                ...
                var range = sublist.Nest(bounds.LowerBound, bounds.Count).Nest(1); // leave the first item alone
                range.Clear();
            }
        ...
        public void TestLowerAndUpperBound_EmptyList_ReturnsEmptySublist()
        {
            ...
            Assert.AreEqual(0, range.Count, "The size of the range was not zero.");
        }
        ...
        public void TestLowerAndUpperBound_SpansEntireList_ReturnsNewSublist()
        {
            ...
            int[] expected = { 1, 1, 1, };
            var sublist = list.Nest(range.LowerBound, range.Count);
        ...
        public void TestLowerAndUpperBound_MissingInMiddle_ReturnsEmptySublistWithCorrectOffset()
        {
            ...
            Assert.AreEqual(0, range.Count, "The count was not zero, even though the value was missing.");
