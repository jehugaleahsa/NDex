...
{
    /// <summary>
    /// Tests the SwapWith methods.
    /// </summary>
    [TestClass]
    public class SwapWithTester
    {
        #region Real World Example

        /// <summary>
        /// SwapWith is useful when needing to swap items between two lists. We'll partition two lists and
        /// then swap out their items.
        /// </summary>
        [TestMethod]
        public void TestSwapWith_PartitionAndSwap()
        {
        ...
        /// </summary>
        [TestMethod]
        public void TestSwapWith_EqualSizedRanges_ReturnsCounts()
        {
        ...
        /// </summary>
        [TestMethod]
        public void TestSwapWith_FirstRangeSmaller_StopsPrematurely()
        {
        ...
        /// </summary>
        [TestMethod]
        public void TestSwapWith_SecondRangeSmaller_StopsPrematurely()
        {
            var list1 = TestHelper.Wrap(new List<int>() { 1, 3, 5, 7, });
