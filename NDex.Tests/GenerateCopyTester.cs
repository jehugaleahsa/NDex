...
{
    /// <summary>
    /// Tests the GenerateCopy methods.
    /// </summary>
    [TestClass]
    public class GenerateCopyTester
    {
        #region Real World Examples

        /// <summary>
        /// GenerateCopy can be used to populate an array with incrementing values.
        /// </summary>
        [TestMethod]
        public void TestGenerateCopy_Counting()
        {
        ...
        /// <summary>
        /// GenerateCopy can be used to populate an array with default values.
        /// </summary>
        [TestMethod]
        public void TestGenerateCopy_Defaulting()
        {
        ...
        /// <summary>
        /// GenerateCopy can be used to populate an array with random values.
        /// </summary>
        [TestMethod]
        public void TestGenerateCopy_WithRandomValues()
        {
            Random random = new Random();
            int[] values = new int[10];
            Sublist.Generate(10, i => random.Next(1, 10)).CopyTo(values.ToSublist());  // fixed length version of Grow!
            Assert.IsFalse(values.ToSublist().Find(i => i == 0), "Not all of the values were filled in.");
        }
        ...
        public void TestGenerateCopy_NullGenerator_Throws()
        {
            int numberOfItems = 0;
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestGenerateCopy_NullIndexedGenerator_Throws()
        {
            int numberOfItems = 0;
        ...
        /// </summary>
        [TestMethod]
        public void TestGenerateCopy_SetValueType()
        {
        ...
        /// </summary>
        [TestMethod]
        public void TestGenerateCopy_WithGenerator_CallCtor()
        {
        ...
        /// </summary>
        [TestMethod]
        public void TestGenerateCopy_IncrementingCount()
        {
